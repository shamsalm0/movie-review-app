            ...
            <div class="card border-0 shadow-lg mt-3">
                ...
                <div class="card-body sidebar">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a href="Movie-listing.html">Movies</a>                               
                        </li>
                        <li class="nav-item">
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('director') is-invalid @enderror" placeholder="Director"  name="director" id="director"/>
                        @error('director')
                        <p class="invalid-feedback">{{$message}}</p>
                    @enderror
                    </div>
